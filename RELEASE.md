...
* zip the **dev** dir. Save it with a name like *jayo-async-stream-0.1.0-alpha1.zip*.
* upload manually on https://central.sonatype.com/publishing (jayo account)
  * do **Publish Component**
  * Deployment name → use release name *jayo-async-stream-X.Y.Z*, use the same name as the zip.
