...
[![Version](https://img.shields.io/maven-central/v/dev.jayo/jayo-async-stream?logo=apache-maven&color=&style=flat-square)](https://search.maven.org/artifact/dev.jayo/jayo-async-stream)
...
The Jayo AsyncStream code is written in Java without the use of any external dependencies, to be as light as possible.
